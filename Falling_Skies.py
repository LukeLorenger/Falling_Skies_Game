...
player.shape("deer.gif") # Shape of player
...
for _ in range(20):
    ...
    bad_guy.shape("hunter.gif") # Shape of player
...
def go_left():
    ...
    player.shape("deer.gif") # Original or left facing

def go_right():
    player.direction = "right"
    player.shape("deerright.gif") # right facing
